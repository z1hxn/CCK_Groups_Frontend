    ...
    <div className="comp-page">
      ...
      <div className="comp-content admin-content">
        <div className="admin-placeholder">
          <strong>자동 조편성</strong>
          <span>아직 구현되지 않았습니다.</span>
        </div>
              ...
              <tbody>
                {rows.map((item) => (
                  <tr
                    ...
                    onClick={() => navigate(`/admin/competition/${competitionId}/player/${encodeURIComponent(item.cckId)}`)}
                    onKeyDown={(event) => {
        ...
        <Link className="player-back-link" to={`/competition/${competitionId}`}>
          대회 페이지로 이동
        </Link>
      </div>
    </div>
